    ...
    <div className="flex min-h-screen items-center justify-center bg-paper px-4">
      <div className="w-full max-w-sm">
        <div className="mb-8 flex flex-col items-center text-center">
          ...
          <p className="text-sm text-ink-soft">We&apos;ll email you a link to set a new one.</p>
        </div>

        <div className="rounded-lg border border-rule bg-paper-raised p-6 shadow-sm">
          {sent ? (
            <div className="flex flex-col items-center text-center">
              <CheckCircle2 className="mb-3 text-status-completed" size={32} />
        ...
        <Link href="/login" className="mt-4 flex items-center justify-center gap-1 text-sm text-ink-soft hover:text-ink">
